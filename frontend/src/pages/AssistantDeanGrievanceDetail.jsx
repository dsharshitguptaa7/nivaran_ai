...
function AssistantDeanGrievanceDetail() {
  ...
  async function loadGrievance() {
    ...
    try {
      ...
      console.error(
        "Assistant Dean grievance detail error:",
        err
      );
  ...
  async function handleForwardToAssociateDean() {
    ...
    const confirmed =
      window.confirm(
        "Forward this grievance to Associate Dean?"
      );
    ...
    try {
        ...
        await fetch(
          `http://127.0.0.1:8000/api/v1/grievances/${grievance.grievance_id}/escalate`,
          {
            ...
            body: JSON.stringify({
              ...
              reason:
                "Further administrative review is required.",

              remarks:
                remarks ||
                "Forwarding to Associate Dean for further review.",
      ...
      setActionMessage(
        "Grievance successfully forwarded to Associate Dean."
      );
      ...
      console.error(
        "Forward to Associate Dean error:",
        err
      );
          ...
          <section className="authority-content-card authority-role-actions">
            ...
            <div className="authority-card-body">
              ...
              <div className="authority-action-info">
                ...
                <strong>
                  Current Level: Assistant Dean
                </strong>

                <p>
                  Review the grievance and forward it
                  to the Associate Dean when further
